...
2.	Copy the BankPortalDB.bak file to the sqldbs container of the storage account created from the initial deployment. You should assign your Azure account the  
